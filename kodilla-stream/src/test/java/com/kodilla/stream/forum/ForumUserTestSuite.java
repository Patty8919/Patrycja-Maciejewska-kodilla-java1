...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOfFriends(){
        ...
        ForumUser user6 = new ForumUser("bigmac", "Robert Macdonald", "Washington");
        ForumUser user7 = new ForumUser("thebigone", "Clay Small", "Orlando");
        ForumUser user8 = new ForumUser("user121212", "Marisa Frank", "Washington");
        ForumUser user9 = new ForumUser("lawyer", "Lexie John", "Miami");
        ForumUser user10 = new ForumUser("nobody", "Briana Williams", "Miami");
